...
internal class OpenGLTexture2D : Texture2D {
    ...
    private fun createGLTexture(glTarget: Int) {
        ...
        id = ids[0]
        ShaderStats.recordTextureCreated()
...
internal fun Texture.ImageFormat.toGlInternalFormat(): Int {
    return when (this) {
        ...
        Texture.ImageFormat.RGBA8 -> GLES30.GL_SRGB8_ALPHA8  // Keep sRGB for loaded textures
        Texture.ImageFormat.SRGB8_ALPHA8 -> GLES30.GL_SRGB8_ALPHA8  // Explicit sRGB
...
internal fun Texture.ImageFormat.getDataType(): Int {
    ...
    return when (this) {
        ...
        Texture.ImageFormat.SRGB8_ALPHA8 -> GLES30.GL_UNSIGNED_BYTE
...
internal fun Texture.ImageFormat.toGlImageFormat(): Int {
    return when (this) {
        ...
        Texture.ImageFormat.RGBA8,
        Texture.ImageFormat.SRGB8_ALPHA8,
        Texture.ImageFormat.RGB10_A2 -> GLES30.GL_RGBA
