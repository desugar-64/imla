...
import dev.serhiiyaremych.imla.internal.render.opengl.OpenGLTexture2D
...
internal interface Texture {
    ...
    enum class ImageFormat {
        ...
        RGB8,
        RGBA8,
        SRGB8_ALPHA8,  // sRGB with hardware gamma correction
        RGB10_A2,
        DEPTH24STENCIL8
    }
    ...
    data class Specification(
        ...
        @Deprecated(
            "Use coordinateOrigin.needsFlipForOpenGL()",
            ReplaceWith("coordinateOrigin.needsFlipForOpenGL()")
        )
        var flipTexture: Boolean
            get() = coordinateOrigin.needsFlipForOpenGL()
            set(_) {}
    }
