...
import dev.serhiiyaremych.imla.internal.render.opengl.OpenGLUniformBuffer
import dev.serhiiyaremych.imla.internal.render.opengl.buffer.OpenGLIndexBuffer
import dev.serhiiyaremych.imla.internal.render.opengl.buffer.OpenGLVertexBuffer
...
internal interface VertexBuffer : GfxBuffer {
    ...
    fun setData(data: FloatArray, count: Int)
